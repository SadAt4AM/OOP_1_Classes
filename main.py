...
class Reviewer(Mentor):
    ...
    #Методы вычисления средних оценок
...
cool_student = Student("Too", "Basic", "famale")
cool_student.courses_in_progress += ["Python"]

a_student = Student('King', 'Lord', 'male')
...
cool_reviewer.rate_hw(a_student, 'Python', 5)
cool_reviewer.rate_hw(a_student, 'Python', 6)
cool_reviewer.rate_hw(a_student, 'Python', 4)
...
cool_student.rate_lector(test_lector, "Git", 10)

cool_student.rate_lector(cool_lector, "Git", 10)
